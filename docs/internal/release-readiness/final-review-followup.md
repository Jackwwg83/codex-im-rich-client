...
**P3**
- Current workspace still has untracked review artifacts, including `.stderr` files with fake token-shaped literals, e.g. [docs/phase-2/codex-review-t18-t22.stderr](/Users/jackwu/projects/codex-im-rich-client/docs/phase-2/codex-review-t18-t22.stderr:6154) and [docs/phase-3/impl-t1-t36-final-codex-review.stderr](/Users/jackwu/projects/codex-im-rich-client/docs/phase-3/impl-t1-t36-final-codex-review.stderr:13035). They are not in committed HEAD, but keep them out of the final handoff/tag packet.
