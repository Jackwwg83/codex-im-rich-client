...
- Live smoke docs: `docs/ops/lark-live-smoke.md`.

## 3. Review / fixes

- Final implementation review initially rejected at `f51c7c6`.
- `50a90c4` closed the 2 P1 blockers and original P2 findings.
- Final re-review returned GO_WITH_LOW_NITS; report: `docs/phase-4/impl-final-codex-rereview.md`.
...
2. Create a Phase 5 plan under `docs/superpowers/plans/`.
