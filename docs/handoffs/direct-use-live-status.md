...
> evidence; after the JAC-262 bridge reinstall/kickstart, launchd is running
> under pid `86364` with `pendingApprovals=0`. Common group safety now has a config-level mention
