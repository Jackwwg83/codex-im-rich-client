...
P1 - `docs/superpowers/plans/2026-05-02-phase-5-dingtalk-plan.md`, T11 / Linear child issues  
...
P2 - `docs/superpowers/plans/2026-05-02-phase-5-dingtalk-plan.md`, T5/T6 and Linear table; `docs/handoffs/phase5-live-status.md`, queue  
...
P2 - `docs/superpowers/plans/2026-05-02-phase-5-dingtalk-plan.md`, T3 / Security Model  
...
P2 - `docs/phase-5/dingtalk-target-verification.md`, Required Target Record; `08-DATA-MODEL.md`, inbound dedup  
